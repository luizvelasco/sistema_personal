...
?>
    ...
    <div id="main-container" class="container-fluid">
        <div class="offset-md-4 col-md-4 new-personal-container">
            <h1 class="page-title">Adicionar Aluno</h1>
            <p class="page-description">Adicione seu aluno para acompanhamento</p>
            <form action="<?= $BASE_URL ?>aluno_process.php" id="add-personal-form" method="post" enctype="multipart/form-data">
